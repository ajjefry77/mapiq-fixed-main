...
'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://api.mapbox.com; style-src 'self' 'unsafe-inline' https://api.mapbox.com https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https://*.tile.openstreetmap.org https://api.mapbox.com https://api.maptiler.com https://*.cesium.com https://*.google.com https://mapiq.ir:* https://sat.neshanmap.ir https://*.neshanmap.ir http://localhost:*; connect-src 'self' https://mapiq.ir:* http://localhost:* https://*.tile.openstreetmap.org https://api.mapbox.com https://api.maptiler.com https://events.mapbox.com wss://*.cesium.com https://*.cesium.com https://*.google.com https://sat.neshanmap.ir https://*.neshanmap.ir https://map.ir; worker-src 'self' blob:; child-src 'self' blob:;"    },
    proxy: {
      '/api': {
